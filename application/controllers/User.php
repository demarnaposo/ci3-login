...
class User extends CI_Controller {
    ...
    public function edit() {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Profile Edited!
        </div>');
          redirect('user');
        ...
        if ($this->form_validation->run() == false) {
            ...
            if(!password_verify($current_password, $data['user']['password'])) {
                ...
                if($current_password == $new_passsword) {
                    ...
                    $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">New Password cannot be same current password!
                </div>');
                  redirect('user/changepw');
